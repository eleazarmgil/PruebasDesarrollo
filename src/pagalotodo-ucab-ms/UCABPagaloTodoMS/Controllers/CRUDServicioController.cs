...
public class CRUDServicioController : BaseController<CRUDServicioController>
{
    ...
    ///     ### GET Id del servicio
    ///     ## Url
    ///     POST /crudservicio/AgregarServicio
    /// </remarks>
    ...
    /// <summary>
    /// Endpoint para consultar todos los servicios asociados a un prestador.
    /// </summary>
    /// <remarks>
    /// Este endpoint permite consultar todos los servicios asociados a un prestador registrados en el sistema.
    ///     ## Description
    ///     ### GET lista de servicios 
    ///     ## Url
    ///     GET /crudservicio/ConsultarServiciosEmpresa
    /// </remarks>
    /// <response code="200">
    ///     OK:
    ///     - La operación se completó con éxito y se devuelve una lista de objetos ConsultarServicioEmpresaResponse.
    /// </response>
    /// <response code="400">
    ///     Bad Request:
    ///     - La solicitud del cliente es incorrecta y no se pudo consultar los servicios.
    /// </response>
    /// <returns>Una lista de objetos ConsultarServicioEmpresaResponse que contienen información de todos los servicios registrados para un prestador en especifico.</returns>


    [HttpGet("ConsultarServiciosEmpresa")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
