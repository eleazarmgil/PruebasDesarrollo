...
public static class BuildDataContextFaker
{
    ...
    public static List<ConsultarUsuariosResponse> BuildListaConsultarUsuariosResponse()
    {
    ...
    public static List<ConsultarConsumidorResponse> BuildListaConsultarConsumidorResponse()
    {
    ...
    public static List<ConsultarPrestadorResponse> BuildListaConsultarPrestadorResponse()
    {
    ...
    public static List<PreguntasDeSeguridadResponse> BuildListaPreguntasDeSeguridadResponse()
    {
    ...
    public static List<RecuperarClaveResponse> BuildListaRecuperarClaveResponse()
    {
    ...
    public static Guid BuildGuidAdministradorActualizarPrestadorResponse()
    {
    ...
    public static Guid BuildGuidAdministradorActualizarConsumidorResponse()
    {
    ...
    //Faker de ActualizarConsumidor

    public static Faker<ActualizarConsumidorRequest> BuildActualizarConsumidorRequest()
    {
        Randomizer.Seed = new Random(100);
        return new Faker<ActualizarConsumidorRequest>()
    ...
    public static Guid BuildGuidActualizarConsumidorResponse()
    {
        var data = new AdministradorActualizarConsumidorResponse()
        {
            Id = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
    ...
    public static Guid BuildGuidCambiarClaveUsuarioResponse()
    {
        var data = new AdministradorActualizarConsumidorResponse()
        {
            Id = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
    ...
    public static Guid BuildGuidRegistrarPrestadorResponse()
    {
        var data = new AdministradorActualizarPrestadorResponse()
        {
            Id = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
    ...
    public static Guid BuildGuidRegistrarConsumidorResponse()
    {
        var data = new AdministradorActualizarConsumidorResponse()
        {
            Id = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
    ...
    public static Guid BuildGuidRegistrarServicioResponse()
    {
    ...
    public static List<ConsultarServiciosResponse> BuildGuidConsultarServiciosResponse()
    {
    ...
    //Faker de ConsultarServiciosEmpresa

    public static ConsultarServicioEmpresaRequest BuildConsultarServicioEmpresaRequest()
    {
        var data = new ConsultarServicioEmpresaRequest()
        {
            id_prestador = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
        };
        return data;
    }
    public static List<ConsultarServicioEmpresaResponse> BuildGuidConsultarServicioEmpresaResponse()
    {
        var data = new List<ConsultarServicioEmpresaResponse>()
        {
            new ConsultarServicioEmpresaResponse()
            {
                id_servicio = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
                nombre = "ServicioFaker",
                monto = 20.00,
                id_prestador = new Guid(),
                nombre_prestador = "NombreFaker",
                nombre_empresa = "EmpresaFaker1",
                descripcion ="Descripcion Faker del servicio",
            },
            new ConsultarServicioEmpresaResponse()
            {
                id_servicio = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
    ...
    public static Guid BuildGuidActualizarServicioResponse()
    {
    ...
    public static AgregarPagoRequest BuildAgregarPagoRequest()
    {
        AgregarPagoRequest agregarPagoRequest = new AgregarPagoRequest
        {
            monto = 123.45,
            OpcionDePagoIdEntity = Guid.NewGuid(),
            ConsumidorIdEntity = Guid.NewGuid(),
            detalledepago = new List<DetalleDePagoRequest>()
                {
                    new DetalleDePagoRequest
                    {
                        detalle = "Faker1",
                    },
                }
        ...
        return agregarPagoRequest; 
    }
    public static Guid BuildGuidAgregarPagoResponse()
    {
        var data = new AgregarPagoResponse()
        {
            Id = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
        };
        return (Guid)data.Id;
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //                                             FAKER DE AgregarOpcionDePago
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    //Faker de AgregarOpcionDePago
    public static AgregarOpcionPagoRequest BuildAgregarOpcionDePagoRequest()
    {
        AgregarOpcionPagoRequest agregarOpcionPagoRequest = new AgregarOpcionPagoRequest
        {
            nombre = "NombreFaker",
            ServicioEntityId = Guid.NewGuid(),
            detalleDeOpcion = new List<DetalleDeOpcionRequest>()
                {
                    new DetalleDeOpcionRequest
                    {
                        nombre= "NombreFaker",
                        formato = DetalleDeOpcionRequest.formato_dato.Telefono,
                    },
                }

        };
        return agregarOpcionPagoRequest;
    }
    public static Guid BuildGuidAgregarOpcionDePagoResponse()
    {
        var data = new AgregarOpcionPagoResponse()
        {
            ServicioEntityId = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
        };
        return (Guid)data.ServicioEntityId;
    }

    //Faker de ConsultarOpcionDePagoPorId

    public static ConsultarOpcionDePagoPorIdRequest BuildConsultarOpcionDePagoPorIdRequest()
    {
        var data = new ConsultarOpcionDePagoPorIdRequest()
        {
            opciondepago_id = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
        };
        return data;
    }

    public static List<ConsultarOpcionDePagoPorIdResponse> BuildConsultarOpcionDePagoPorIdResponse()
    {
        var data = new List<ConsultarOpcionDePagoPorIdResponse>()
        {
            new ConsultarOpcionDePagoPorIdResponse()
            {
                Id = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
                nombre= "Faker",
                estatus ="Activo"
    ...
    //Faker de ConsultarDetalleDeOpcion

    public static ConsultarDetalleDeOpcionDePagoRequest BuildConsultarDetalleDeOpcionRequest()
    {
        var data = new ConsultarDetalleDeOpcionDePagoRequest()
        {
            opciondepago_id = new Guid("f1da2b15-922e-44ce-92bb-07b069b43dfc"),
        };
        return data;
    ...
    public static List<ConsultarDetalleDeOpcionDePagoResponse> BuildConsultarDetalleDeOpcionResponse()
    {
        var data = new List<ConsultarDetalleDeOpcionDePagoResponse>()
        {
            new ConsultarDetalleDeOpcionDePagoResponse()
            {
                formato = "Formato",
                nombre = "Faker",
            }
